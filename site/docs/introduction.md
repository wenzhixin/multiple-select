...
The folks over at [UNPKG](https://unpkg.com/multiple-select@1.6.0/dist/) graciously provide CDN support for CSS and JavaScript of Multiple Select. Just use these links.

```html
https://unpkg.com/multiple-select@1.6.0
```
