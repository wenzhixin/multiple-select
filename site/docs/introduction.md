...
The folks over at [UNPKG](https://unpkg.com/multiple-select@2.1.1/dist/) graciously provide CDN support for Multiple Select's CSS and JavaScript. Just use these links.
